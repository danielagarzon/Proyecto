# -*- coding: utf-8 -*-
"""
Created on Thu Dec 10 14:51:26 2020

@author: ESPERANZA
"""

"""
Created on Sun Dec  6 00:23:06 2020
...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  3 09:20:26 2020
...
pantalla.grid(row=6,column=3,padx=10, pady=10, columnspan=4)
...
boton7.grid(row=7,column=3)
boton8=Button(miFrame, text='8',width=3,command=lambda:numeroPulsado('8'))
boton8.grid(row=7,column=4)
boton9=Button(miFrame, text='9',width=3,command=lambda:numeroPulsado('9'))
boton9.grid(row=7,column=5)
#botondiv=Button(miFrame, text='/',width=3)
#botondiv.grid(row=7,column=5)
#_______________fila2 __________________________
boton4=Button(miFrame, text='4',width=3, command=lambda:numeroPulsado('4'))
boton4.grid(row=8,column=3)
boton5=Button(miFrame, text='5',width=3,command=lambda:numeroPulsado('5'))
boton5.grid(row=8,column=4)
boton6=Button(miFrame, text='6',width=3,command=lambda:numeroPulsado('6'))
boton6.grid(row=8,column=5)
...
boton0.grid(row=10,column=3)
botonigual=Button(miFrame, text='=',width=3,command=lambda:el_resultado())
botonigual.grid(row=10,column=4)
botoncoma=Button(miFrame, text=',',width=3,command=lambda:numeroPulsado(','))
botoncoma.grid(row=10,column=5)
botonsuma=Button(miFrame, text='+',width=3,command=lambda:suma(numeroPantalla.get()))
botonsuma.grid(row=11,column=4)
